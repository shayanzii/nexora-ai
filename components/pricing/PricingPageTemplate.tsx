...
import { moneyBackGuarantee, monthlySupportTiers, pricingFaq } from "@/lib/pricing/content";
  ...
  return (
    <div className="nexora-page-bg nexora-marketing-page min-h-screen text-nexora-muted">
      ...
      <main id="main-content">
          ...
          <div className="mx-auto max-w-7xl">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <h1 className="text-4xl font-semibold leading-tight text-nexora-text sm:text-5xl lg:text-6xl">
                Premium AI packages—starting at CA$499.
              </h1>
              <p className="mt-6 text-lg leading-8 text-nexora-muted sm:text-xl">
                Three clear packages built for businesses ready to invest in growth—not cheap widgets.
              </p>
              <PricingHeroActions />
              <div className="mt-10 flex flex-wrap items-center justify-center gap-6 text-sm">
                ...
                <span className="hidden h-4 w-px bg-nexora-border sm:block" aria-hidden="true" />
                <span className="text-nexora-muted">Canadian-based support</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="monthly-support" className="nexora-section px-6 lg:px-8">
          <div className="nexora-glow nexora-card mx-auto max-w-7xl rounded-[2rem] p-8 shadow-[0_0_60px_rgba(0,0,0,0.45)] lg:p-12">
            <div className="max-w-2xl">
              ...
              <h2 className="nexora-heading-section mt-3">Keep your AI sharp after launch.</h2>
              <p className="mt-4 text-lg leading-8 text-nexora-muted">
                Optional care plans for updates, monitoring, and ongoing optimization—so your AI stays accurate as your
                business grows.
              </p>
            </div>
            <div className="mt-12">
        ...
        <section id="guarantee" className="nexora-section px-6 lg:px-8">
          <div className="nexora-glow nexora-card mx-auto max-w-7xl overflow-hidden rounded-[2rem] border-nexora-primary/25 p-8 shadow-[0_0_80px_rgba(185,28,28,0.12)] lg:p-12">
            <div className="flex flex-col gap-8 lg:flex-row lg:items-start">
              ...
              <div className="flex-1">
                ...
                <h2 className="nexora-heading-section mt-3">{moneyBackGuarantee.title}</h2>
        ...
        <section id="faq" className="nexora-section px-6 lg:px-8">
          <div className="mx-auto max-w-3xl">
            <div className="text-center">
              <p className="nexora-eyebrow">FAQ</p>
              <h2 className="nexora-heading-section mt-3">Pricing questions, answered.</h2>
            </div>
        ...
        <section className="px-6 pb-24 lg:px-8 lg:pb-32">
          <div className="nexora-glow nexora-card mx-auto max-w-7xl rounded-[2rem] border-nexora-primary/25 p-8 shadow-[0_0_80px_rgba(185,28,28,0.1)] lg:p-12">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <h2 className="nexora-heading-section mt-3">Not sure which package fits your business?</h2>
              <p className="mt-5 text-lg leading-8 text-nexora-muted">
                Book a free call and we&apos;ll recommend the right plan—or put together a custom quote for Business AI.
              </p>
              <PricingFinalCta />
            </div>
          </div>
